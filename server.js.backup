...
// Static file serving with proper MIME types (works in both dev and production)
...
// Main route - serve index.html for root requests
app.get('/', (req, res) => {
  log('debug', 'Serving index.html for root request');
